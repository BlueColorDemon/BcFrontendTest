!function () {
    var e, t = function () { }, o = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], n = o.length;
...
!function () {
    ...
    angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p, h, M, y, C, v, S) {
        function w() {
...
!function () {
    "use strict";
    angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p, h, M, y) {
        function C(o) {
        ...
        r.find("#chatArea").on("drop", function (e) {
            var t = i.setSendFileUsername(i.getCurrentUserName());
            return t ? void 0 : (alert(MM.context("599d8df")),
            e.preventDefault(),
            e.stopPropagation(),
...
!function () {
    "use strict";
    angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g) {
        function p() {
        ...
        function h() {
            ...
            A = I.getRangeAt(0)) : A = document.selection.createRange()
        }
        function M() {
            A ? window.getSelection ? (I.removeAllRanges(),
            I.addRange(A)) : A.select() : y()
        }
        function y() {
            var e, t;
            ...
            require.async(["webuploader"], function (e) {
                ...
                try {
                    H = e.create({
                        ...
                        else if (e.ToUserName || (e.ToUserName = s.getSendFileUsername()),
                        N(e, z),
                        "gif" !== e.ext.toLowerCase() && !T(e.ext)) {
                            var n = E(e.ext);
                            if (n == a.MSGTYPE_VIDEO && e.size >= 1024 * j * 1024)
                                return H.skipFile(e),
                                void alert(MM.context("9a7dbbc"));
                            e.ToUserName != s.getCurrentUserName() && (u.reportSendState("sendFileWrong"),
                            g.report(g.ReportType.sendError, {
                                type: "sendFileWrong",
                        ...
                        return H.md5File(e).then(function (t) {
                            ...
                            e.size > 1048576 ? (u.reportSendState("MD5TimeBigFilePerMb", Math.floor(l)),
                            u.reportSendState("MD5TimeBigFilePerMbCount")) : (u.reportSendState("MD5TimeSmallFile", s),
                            u.reportSendState("MD5TimeSmallFileCount"));
                            var f, d = {
                            ...
                            if (r) {
                                ...
                                o({
                                    ...
                                    n(e, t.MediaId, t)) : (e.MMSendMsg && (e.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_FAIL,
                                    e.MMSendMsg.MMStatus = a.MSG_SEND_STATUS_FAIL),
                                    alert(t.BaseResponse.ErrMsg))
                                }).error(function () {
                                    e.MMSendMsg && (e.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_FAIL,
                                    e.MMSendMsg.MMStatus = a.MSG_SEND_STATUS_FAIL),
                                    alert("上传失败")
                                })
                            } else
        ...
        var I, A, F = document.getElementById("caretPosHelper"), k = 0, U = 0, D = document.getElementById("editArea"), R = D.parentNode, x = u.getShareObject("editingContents"), O = !1;
        $(D).on("input", function () {
            h()
        }).on("click", function () {
            h()
        ...
        t.sendClick = function (e) {
            ...
            return t ? void 0 : ((!G || e.timeStamp - G > 30) && (G = e.timeStamp,
            alert(MM.context("599d8df"))),
            e.preventDefault(),
            e.stopPropagation(),
            !1)
        }
        ...
        var H, j = 20, q = 25, K = {
            ...
            onQueued: function () {
                if ((T(this.ext) || "gif" == this.ext.toLowerCase()) && this.ToUserName != s.getCurrentUserName() && (u.reportSendState("sendImageWrong"),
                g.report(g.ReportType.sendError, {
                    type: "sendImageWrong",
                    browser: u.browser.msie ? "ie" : "other"
                })),
            ...
            onProgress: function (e) {
                var o = this;
                t.$apply(function () {
                    o.MMSendMsg && (o.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_SENDING,
...
!function () {
    "use strict";
    angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p) {
        o(function () {
        ...
        function h(o, n, s, l, d) {
            ...
            switch (+n) {
                case a.MSGTYPE_TEXT:
                    t.contextMenuList = [];
                    var y;
                    if (y = M.isRoomContact() ? h.getMemberDisplayName(g.FromUserName) || h.NickName : h.NickName,
                    s && parseInt(s))
                        return void (t.isShowContextMenu = !1);
...
!function () {
    "use strict";
    angular.module("Controllers").controller("transpondDialogController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p) {
        function h(e, t) {
...
!function (_aoUndefined) {
    ...
    angular.module("Services").factory("chatFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "notificationFactory", "utilFactory", "reportService", "mmHttp", "titleRemind", function ($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
        ...
        var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "", _addedMsgIdsMap = {}, _msgMap = {}, _sendFileUserName, service = {
            ...
            _sendCheck: function (e) {
                ...
                if (t && o) {
                    ...
                    a == i && i == e ? !0 : (i != e && utilFactory.reportSendState("toUserNameConflictNav"),
                    a != e && utilFactory.reportSendState("toUserNameConflictChat"),
...
!function () {
    ...
    angular.module("Services").factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c, s, l, u) {
        ...
        var d, m = window._contacts = {}, g = window._strangerContacts = {}, p = [], h = [], M = [], y = [], C = window._chatRoomMemberDisplayNames = {}, v = [], S = [], w = [], b = {}, T = {}, E = 0, N = ["fmessage"], P = {
            isSelf: function () {
    ...
    angular.module("Services").factory("utilFactory", ["$q", "$rootScope", "confFactory", function (e, t, o) {
        ...
        var u = {
            ...
            reportIdkey: function (e, t, o) {
                var n = "https://support.weixin.qq.com/cgi-bin/mmsupport-bin/reportforweb?rid=" + e + "&rkey=" + t + "&rvalue=" + (o || 1);
                (new Image).src = n
            },
            isUserName: function () { },
...
!function () {
    ...
    angular.module("Services").factory("notificationFactory", ["utilFactory", function (e) {
        ...
        function r() {
            var e;
            return g ? (window.Notification && window.Notification.permissionLevel ? e = window.Notification.permissionLevel() : window.webkitNotifications && window.webkitNotifications.checkPermission ? e = f[window.webkitNotifications.checkPermission()] : window.Notification && window.Notification.permission ? e = window.Notification.permission : navigator.mozNotification ? e = l : window.external && void 0 !== window.external.msIsSiteMode() && (e = window.external.msIsSiteMode() ? l : s),
            e) : void 0
        }
        function a(e) {
...
!function () {
    ...
    angular.module("Services").factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function (e, t, o, n) {
        ...
        var y, C = 3e3, _ = [], v = [], S = {}, w = "reportService", b = m(), T = {
            jsError: "[js-error]",
...
!function () {
    ...
    angular.module("Services").factory("mmHttp", ["$http", "$q", "$timeout", function (e, t, o) {
        function n(n) {
            ...
            function s() {
                return M >= d || l.complete ? !1 : (g && (y.resolve(),
                y = t.defer(),
                u.timeout = y.promise),
                M++,
                r(n.method, n.args),
                ...
                n.bind("paste", function () {
                    ...
                    s = setTimeout(function () {
                        ...
                        if (-1 != l && -1 != u) {
                            ...
                            var _ = i(g).replace(/&nbsp;/g, " ").replace(new RegExp("<(?!br|" + o.EMOTICON_REG + ").*?>", "g"), "").replace(new RegExp("&lt;(br|" + o.EMOTICON_REG + "/?)&gt;", "g"), "<$1>").replace(/<img.*?class="(.*?)" text="(.*?)" .*?>/g, function () {
                        ...
                        if (c) {
                            switch (e.keyCode) {
                                case o.KEYCODE_ARROW_UP:
                                    do
                                        c = c._index - 1 < 0 ? m : u[c._index - 1];
                                    while (!n(c)); c == m && (r = !0);
                                    break;
                                case o.KEYCODE_ARROW_DOWN:
                                    do
                                        c = c._index + 1 >= u.length ? m : u[c._index + 1];
                                    while (!n(c)); break;
                                default:
                                    return
                            }
...
angular.module("Directives").directive("navReadDirective", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "$state", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", "subscribeMsgService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m) {
    function g(e) {
...
angular.module("Directives").directive("mmSrc", ["$document", "$timeout", "$rootScope", function (e, t) {
    return {
        ...
        link: function (e, o, n) {
            ...
            var s, l, u = "src", f = n.src, d = n.mmSrcTimeout ? parseInt(n.mmSrcTimeout) : 5e3, m = n.mmSrcRetryCount ? parseInt(n.mmSrcRetryCount) : 4, g = "undefined" != typeof n.mmSrcParallel, p = o[0], h = 0, M = !1, y = [], C = [], _ = n.mmSrcLoad, v = n.mmSrcError;
...
function () {
    ...
    function c(t, o) {
        t[o >> 5] |= 128 << o % 32,
        t[(o + 64 >>> 9 << 4) + 14] = o;
        var c, s, l, u, f, d = 1732584193, m = -271733879, g = -1732584194, p = 271733878;
